        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-wrap items-center justify-between">
            <div className="w-full md:w-1/2 md:px-4">
              <div className="pb-6 space-y-6 md:max-w-md lg:max-w-lg xl:max-w-xl">
                <p className="text-lg text-gray-700">
                  Vighnaharata Trust's Shivajirao S. Jondhle College of Engg. & Technology, Asangaon. Department of Electronics & Telecommunication Engg.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2">
              <div className="overflow-hidden rounded-md shadow-xl">
                <img className="w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkWR7vG_pc_G82S2e3SWD0bmnuoEQJzF75Y0L_TxVY&s" alt="college pic" />
              </div>
            </div>
          </div>
        </div>
